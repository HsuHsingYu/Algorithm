public class HW09_4108056052_2 extends LSD
{
    ...
    static class Graph
    {
        private final HashAdjList adjList;
        private final FiniteQueue queue;
    ...
    public static class ArrayListLite
    {
        private int cap;
        private int len;
        private int[] elem;
        ...
        public final void add(int n)
        {
            ...
            else
            {
                ...
                if (len >= 0) System.arraycopy(elem, 0, newElem, 0, len);
                newElem[this.len] = n;
                this.elem = newElem;
            }
        }
